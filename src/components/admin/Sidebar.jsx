...
export default function Sidebar() {
    ...
    const items = [
        ...
        },
        {
            ...
            icon: <FaHouseChimney size={22} />
        },
        {
            name: "Product",
            path: "/admin/product",
            icon: <GrProductHunt size={22} />
        },
        {
            name: "Color",
            path: "/admin/color",
            icon: <IoMdColorPalette size={22} />
        }
    ];

    return (
        <div className={`${toggle ? 'w-20' : 'w-64'} duration-300 h-screen  sticky z-50 top-0 bg-[#3b497e] shadow-xl`}>
            {/* Header */}
                ...
                {items.map((item, index) => {
                    ...
                    return (
                        <div key={index} className='relative group'>
                            ...
                            {/* Tooltip - single line className to avoid hydration mismatch */}
                            {toggle && (
